...
1. Robinson, J. A. (1965). *A Machine-Oriented Logic Based on the Resolution
...
5. Blanchette, J. C., Fleury, M., Lasserre, M., & Weidenbach, C. (2018). *A
   ...
   Verified CDCL framework.

## Supplementary authoritative resources

- [SAT Competition benchmark archive](https://satcompetition.github.io/), for
  versioned DIMACS benchmark provenance.
- [SMT-LIB](https://smt-lib.org/), for theory-aware benchmark formats and logic
  specifications.
